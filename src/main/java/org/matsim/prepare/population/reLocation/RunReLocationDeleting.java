...
public class RunReLocationDeleting {

    private static final Logger log = Logger.getLogger(RunReLocationDeleting.class);
...
//            planFile = "https://svn.vsp.tu-berlin.de/repos/public-svn/matsim/scenarios/countries/de/berlin/berlin-v5.5-10pct/input/berlin-v5.5-10pct.plans_uncalibrated.xml.gz";
            planFile = "D:/Bachelor/randomReLocation/preparingPlans/PlansForDrt.output_plans.xml.gz";
...
//        oldShoppingActivities.clear();
        ...
        createNewPopulation(outputPlans, null, null, null, population);
